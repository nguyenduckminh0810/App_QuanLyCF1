...
public class SuaThongTinKhachhangJDialog extends javax.swing.JDialog {
    ...
    public SuaThongTinKhachhangJDialog(java.awt.Frame parent, boolean modal, HoaDonEntity hd) {
        super(parent, modal);
        initComponents();
    ...
    private void btnCapNhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCapNhapActionPerformed
        ...
        if (txtTienShip.getText().length() < 4 && Integer.parseInt(txtTienShip.getText()) != 0) {
            JOptionPane.showMessageDialog(this, "Tiền ship phải từ 1.000 đồng trở lên");
            return;
        }
        HoaDonEntity capnhaphoadon = updateBill();
...
public void filltext() {
    ...
    public HoaDonEntity updateBill() {
        HoaDonEntity hd = hoadon;
