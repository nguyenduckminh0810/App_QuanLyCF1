...
public class QLDonViDoUongJDialog extends javax.swing.JDialog {
    ...
    private void filltableDonVi() {
        ...
        model.setRowCount(0);
        List<DonViSanPhamEntity> list = dao.selectAll();
        for (DonViSanPhamEntity x : list) {
            model.addRow(new Object[]{x.getID_DonviSP(), x.getTenDonvi(), x.getKichthuoc(), x.getThemTien()});
        }
    }

    private void setform(DonViSanPhamEntity dv) {
    ...
    private DonViSanPhamEntity getform() {
    ...
    private void edit() {
        ...
        DonViSanPhamEntity dv = dao.selectID(id);
        setform(dv);
    }
    ...
    private boolean checkPK() {
        List<DonViSanPhamEntity> list = dao.selectAll();
        for (DonViSanPhamEntity dv : list) {
