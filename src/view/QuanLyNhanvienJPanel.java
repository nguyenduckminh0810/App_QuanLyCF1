...
public class QuanLyNhanvienJPanel extends javax.swing.JPanel {
    ...
    int row = -1;
    //Tạo fileChooser với đường dẫn mặc định là "C:\Users\ngminh\Desktop\DA1\QuanLyUpCoffee (1)\logos"
    //Khi khởi tạo đối tượng sẽ cho người dùng chọn tệp từ đường dẫn
    ...
    //Phương thức này dùng để xác định xem người dùng đăng nhập 
    //là Quản lý hay Nhân viên từ đó mới cấp quyền có thể thêm sửa xoá Nhân viên
    public void authen() {
        if (Auth.isManager()) {//Nếu là quản lý: có thể thêm sửa xoá nhân viên
            btnThem.setEnabled(true);
            btnSua.setEnabled(true);
            btnXoa.setEnabled(true);
            tbnLamMoi.setEnabled(true);
        } else {//Nếu là nhân viên: không thể thêm sửa xoá
            //Cho các nút không hiện lên màn hình nữa
...
void init() {
    ...
    //Set form của bảng nv hoạt đông
    void edit() {
    ...
    //Set form của bảng nv kh hoạt đông
    void edit2() {
    ...
    //Lấy dữ liệu về đối tượng NhanVien
    public NhanVienEntity getForm() {
        NhanVienEntity nv = new NhanVienEntity();
        nv.setId_Nhanvien(txtMaNV.getText());
        nv.setTenNV(txtTenNV.getText());
        nv.setGender(rdoNam.isSelected());
        //1: Lấy giá trị ngày về từ giao diện người dùng
        //2: Chuyển đổi ngày thành một chuỗi định dạng "yyyy-mm-dd"
        //3: Sau đó đổi chuỗi định dạng về thành đối tượng "date"
        //4: Thiết lập giá trị cho đối tượng nv qua phương thức setNgaySinh 
    ...
    //Cập nhật trạng thái cho btn và txt với edit() đối với bảng nv hoạt động
    void updateStatus() {
    ...
    //Cập nhật trạng thái cho btn và txt với edit2() đối với bảng nv không hoạt động
    void updateStatus2() {
        boolean edit = this.row >= 0;
...
//        }
    ...
    public void fillTableSearch(String nhanVien) {
        ...
        try {
            ...
            List<NhanVienEntity> list = dao.selectByKeyword(keyword);
            for (NhanVienEntity nv : list) {
                model.addRow(new Object[]{
                    nv.getId_Nhanvien(),
                    nv.getTenNV(),
