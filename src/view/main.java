...
public class main extends javax.swing.JFrame {
    ...
    //Mấy pnClicked để thay đổi màu trạng thái với bật các panel lên 
    ...
    private void mnThoatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnThoatActionPerformed
        ...
        int result = JOptionPane.showConfirmDialog(this, "Bạn chắc chắn muốn thoát khỏi phiên làm việc?", "App Quản Lý Coffee", JOptionPane.YES_NO_OPTION);
        if (result == JOptionPane.YES_OPTION) {
            Auth.clear();
            lblNameNV.setText("Welcome Here!");
