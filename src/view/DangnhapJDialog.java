...
public class DangnhapJDialog extends javax.swing.JDialog {
    ...
    public boolean check(){
        ...
        NhanVienEntity nhanVien = dao.selectByAccount(manv);
    ...
    private void dangNhap() {
        String manv = txtUserName.getText().trim(); //bỏ khoảng trắng đầu cuối và lấy tên đăng nhập
//        String matKhau = new String(jPasswordField1.getPassword()).trim();
        NhanVienEntity nhanVien = dao.selectByAccount(manv);//Tìm nhân viên xem có trong DB không

            Auth.user = nhanVien;//Đặt nv vào đối tượng auth
            //Kiểm tra trạng thái làm việc của nhân viên
            if(nhanVien.isTrangThai() == true){
            if (Auth.isManager() == true) {//Kiểm tra ng đnăg nhập có phải là quản lý không
        ...
        } else {//nếu tài khoản bị khoá
            int result = JOptionPane.showConfirmDialog(this, "Tài khoản này đã bị khóa! Vui lòng liên hệ quản lý để mở!", "App Quản Lý Coffee", JOptionPane.YES_NO_OPTION);
