...
public class LydohuySanPhamJDialog extends javax.swing.JDialog {
    ...
    public LydohuySanPhamJDialog(java.awt.Frame parent, boolean modal, HoaDonChiTietEntity hdtc) {
        super(parent, modal);
        initComponents();
        hoadonct = hdtc;
        setLocationRelativeTo(null);
    }
    static HoaDonChiTietEntity hoadonct;
    ...
    public void capnhapLydo() {
        HoaDonChiTietEntity hdld = hoadonct;
