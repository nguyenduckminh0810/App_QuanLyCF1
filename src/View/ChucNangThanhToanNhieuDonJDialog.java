...
public class ChucNangThanhToanNhieuDonJDialog extends javax.swing.JDialog {
    ...
    public ChucNangThanhToanNhieuDonJDialog(java.awt.Frame parent, boolean modal, List<HoaDonEntity> list, DefaultTableModel model) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        listhoadonctt = list;
        models = model;
        BanEntity ban = DAOBAN.selectIDHD(listhoadonctt.get(0).getIdHoaDon());
        lblBanSo.setText(ban.getIdBan() + "");
        filltocbo();
    }
    static List<HoaDonEntity> listhoadonctt;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        HoaDonEntity hd = DAOHD.selectById((int) cboDonSo.getSelectedItem());
        List<BanChiTietEntity> listbct = DAObct.selectByIdHD((int) cboDonSo.getSelectedItem());
    ...
    private void btnThanhtoanTaonBoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThanhtoanTaonBoActionPerformed
        ...
        if (btnThanhtoanTaonBo.getText().equalsIgnoreCase("Xác nhận thanh toán")) {
            ...
            btnThanhtoanTaonBo.setText("Thanh toán toàn bộ");
            for (HoaDonEntity hoadon : listhoadonctt) {
...
BanDao DAOBAN = new BanDao();
    ...
    public void filltocbo() {
        ...
        List<HoaDonEntity> list = listhoadonctt;
        for (HoaDonEntity hoadon : list) {
    ...
    public void resetList() {
        List<HoaDonEntity> list = DAOHD.selectCTT(Integer.parseInt(lblBanSo.getText()));
        listhoadonctt = list;
    }
