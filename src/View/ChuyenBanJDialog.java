...
public class ChuyenBanJDialog extends javax.swing.JDialog {
    ...
    private void btnChuyenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChuyenActionPerformed
        ...
        List<BanChiTietEntity> listbct = DAOBANCT.selectByIdBan(idBan);
...
BanDao DAOBAN = new BanDao();
    ...
    public void filltoBan() {
        ...
        List<BanEntity> list = DAOBAN.selectAll();
        for (BanEntity ban : list) {
            List<BanChiTietEntity> listbct = DAOBANCT.selectByIdBan(ban.getIdBan());
            if (!listbct.isEmpty()) {
