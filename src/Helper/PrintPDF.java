...
public class PrintPDF {
    ...
    public void a(DefaultTableModel model, int mahd, int tienkh, int tienthoi) {
        ...
        try {
            File newFile = new File("E:\\zxcnmo\\QuanLyUpCoffee\\printhoadon\\HoaDon_" + mahd + ".pdf");
            PdfWriter.getInstance(document, new FileOutputStream(newFile.getAbsoluteFile().getPath()));
            document.open();
            Font f = new Font(BaseFont.createFont("C:\\Users\\ngminh\\Desktop\\DA1\\QuanLyUpCoffee\\font-times-new-roman.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED));
            f.setSize(16);
            Font f2 = new Font(BaseFont.createFont("C:\\Users\\ngminh\\Desktop\\DA1\\QuanLyUpCoffee\\font-times-new-roman.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED));
            f2.setSize(14);
