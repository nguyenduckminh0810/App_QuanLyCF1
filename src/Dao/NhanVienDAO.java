...
public class NhanVienDAO implements InterfaceNhanVien {
    ...
    public NhanVienEntity selectById(String id) {
        List<NhanVienEntity> list = this.selectBySql(SELECT_BY_ID_SQL, id);
        if (list.isEmpty()) {
            return null;
        }
        return list.get(0);
    ...
    @Override
    public NhanVienEntity selectByAccount(String account) {
        List<NhanVienEntity> list = this.selectBySql(SELECT_BY_ACCOUNT_SQL, account);
        if (list.isEmpty()) {
            return null;
        }
        return list.get(0);
    ...
    public List<NhanVienEntity> select_TrangThai1() {
        return selectBySql(SELECT_TrangThai1);
    }

    public List<NhanVienEntity> select_TrangThai2() {
        return selectBySql(SELECT_TrangThai2);
    }

    public List<NhanVienEntity> selectByKeyword(String keyword) {
    ...
    public List<NhanVienEntity> selectALLL() {
