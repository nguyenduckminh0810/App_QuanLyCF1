...
public class HoadonchitietDAO implements InterfaceHoadonchittiet {
    ...
    @Override
    public void insert(HoaDonChiTietEntity Entity) {
    ...
    @Override
    public void delete(HoaDonChiTietEntity Entity) {
        Helper.JDBCHeper.update(UPDATE_SQL_TrangThai, Entity.isTrangThai(), Entity.getID_Hoadon(), Entity.getID_SanPHam());
    }

    @Override
    public HoaDonChiTietEntity selectById(int id, String MaSP) {
        List<HoaDonChiTietEntity> list = this.selectBySql(SELECT_BY_ID_SQL, id, MaSP);
        if (list.isEmpty()) {
            return null;
        }
        return list.get(0);
    ...
    public List<HoaDonChiTietEntity> selectBySql(String sql, Object... args) {
        ...
        try {
            ...
            while (rs.next()) {
                HoaDonChiTietEntity Entity = new HoaDonChiTietEntity();
    ...
    public List<HoaDonChiTietEntity> selectByIDBan(int idBan) {
        return selectBySql(SELECT_ALL_BY_ID_Ban, idBan);
    }

    @Override
    public List<HoaDonChiTietEntity> selectByIdHD_TT1(int idHD, String idSP) {
        return selectBySql(SELECT_BY_ID_MaHD_TT1, idHD, idSP);
    }

    @Override
    public List<HoaDonChiTietEntity> selectByIdHD_TT0(int idHD, String idSP) {
    ...
    @Override
    public void update_LD(HoaDonChiTietEntity Entity) {
        Helper.JDBCHeper.update(UPDATE_LY_DO_HUY, Entity.getLyDoHuy(), Entity.getID_Hoadon(), Entity.getID_SanPHam());
    }

    public void update_ghichu(HoaDonChiTietEntity Entity) {
    ...
    public List<HoaDonChiTietEntity> selectById1(int id) {
        return this.selectBySql(SELECT_BY_ID_SQL_1, id);
    }

    public List<HoaDonChiTietEntity> selectByIdHD(int id) {
